# FlashBot - A simple Spaced Repetition app for Android
FlashBot is a flashcard app for Android which helps you to build up a strong active vocabulary in your target language. It uses a simple spaced-repetition algorithm, based on the place of a card in the deck, rather than a time-based algorithm (like SuperMemo2). I created FlashBot because I wished to have something *more minimalistic* and *easier to use* than Anki for my own language learning.

[![Google Play Link](https://play.google.com/intl/en_us/badges/images/badge_new.png)](https://play.google.com/store/apps/details?id=de.melvil.FlashBot)

## F.A.Q.

### Which features does FlashBot have?
...
### Which features are missing in FlashBot?
...
### What is the difference between FlashBot and existing SRS systems?
...
### How do you personally use FlashBot for your language learning?
...
### How does the spaced repetition algorithm of Flash work exactly?
Think of the deck as a stack (hence the name *FlashBot*;). You are always tested with the top card of the stack. After showing the answer, you tell the app if you've answered correct or wrong. If you say *wrong*, the card is put back in the stack and will arrive again after three other cards. If you say *correct*, the card is put further back in the stack. Now it gets a little technical. The position is determined by the following formula: 
